...
public class TextIO {
    ...
    public static Console console;  // The GUI IO widget used for simulated input/output.
            ...
            addKeyListener( new KeyAdapter() {
                public void keyTyped(KeyEvent evt) {
                	if(appStarted==false)
                	{
                		...
                		{
                			System.out.println("Not Enter button " + evt.getKeyChar());
                		}
                	}
                	else
                	{
                    ...
                    int R = rand.nextInt(176);
                    int G = rand.nextInt(176);
                    int B = rand.nextInt(176);
    ...
    static {  // static initializer opens the GUI TextIO window.
        ...
        Icon icon = new ImageIcon("assets\\casino.gif");
